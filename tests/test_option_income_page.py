...
class OptionIncomePageTest(unittest.TestCase):
    ...
    def test_page_reads_only_canonical_comparison_artifact(self):
        ...
        self.assertIn('id="chart-scope"', html)
        self.assertIn('id="universe-bars"', html)
        self.assertIn("All ETFs", html)
        self.assertIn("renderUniverseBars", html)
        self.assertIn("chartRows", html)
