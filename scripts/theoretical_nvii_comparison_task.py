...
class TheoreticalNVIIComparison:
    ...
    def __init__(self):
        ...
        self.theoretical_nvii = {
            'base_return': 0.10,
            'dividend_yield': 0.063,
            'target_leverage': 1.25,
            'option_premium_yield': 0.12,
            'volatility_assumption': 0.25,
            'covered_call_allocation': 0.50,
            'unlimited_upside_allocation': 0.50
        }
    def calculate_theoretical_nvii_performance(self):
        ...
        cc_base_return = min(self.theoretical_nvii['base_return'], 0.15)
        ...
        cc_volatility = self.theoretical_nvii['volatility_assumption'] * 0.6
