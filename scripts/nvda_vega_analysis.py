...
class NVDAVegaAnalyzer:
    def __init__(self):
        ...
        self.nvda_price = 140.0
        self.dividend_yield = 0.0025
    ...
    def calculate_vega_evolution(self, strike_prices, initial_volatility=0.35, days_to_expiration=30):
        ...
        """
        time_points = np.linspace(days_to_expiration, 1, days_to_expiration)
        results = {}
...
def main():
    ...
    strike_prices = [130, 135, 140, 145, 150]
